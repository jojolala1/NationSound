...
export default function ArtistScene() {
    ...
    return (
        <div className="d-flex flex-column gap-5 widthCalendar fw-bolder noir p-0">
            {Object.entries(artistes).map(([stage, artiste]) => {
                return (<div className="d-flex flex-column" key={stage}>
                    <h2 className="bgNoir blanc p-3 rounded m-0  text-center ">{stage}</h2>

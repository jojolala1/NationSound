        ...
        <div className="d-flex flex-column align-items-center bgBeige pb-5" >
            ...
            <div className="text-center">
                ...
                <article className=" d-flex flex-column p-5 banner">
                    <p className='rouge titleFont fw-bolder pVideolight h1 mb-4'>Jeudi 05 Septembre</p>
                    <p className="rouge textFont fw-bolder pVideolight h4">{program.jeudi}
                    </p>
                </article>
                ...
                <article className=" d-flex flex-column p-5 banner">
                    <p className='rouge titleFont pVideolight fw-bolder h1 mb-4'>Samedi 07 Septembre</p>
                    <p className="rouge textFont pVideolight fw-bolder h4">{program.samedi}
                    </p>
                </article>
